...
public class UserAll_QuestionDaoTest {
	...
	List<UserAll_Question> userAll_questionEmergentList = dao.select_emergent(new UserAll_Question("", "", "TEST", "", "", "0", 0));
	...
	//("user_id","user_name","user_class","genre","question","emergent")
	System.out.println("---------- select()のテスト ----------");
	List<UserAll_Question> userAll_questionNotEmergentList = dao.select_not_emergent(new UserAll_Question("", "", "TEST", "", "", "1", 0));
